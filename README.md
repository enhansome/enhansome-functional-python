# Awesome functional python with stars
...
* [toolz](https://github.com/pytoolz/toolz) ⭐ 5,155 | 🐛 138 | 🌐 Python | 📅 2026-01-01 ★5150 - "A functional standard library for Python".
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,090 | 🐛 10 | 🌐 Python | 📅 2026-09-06 ★4077 - "More routines for operating on iterables, beyond itertools".
* [funcy](https://github.com/suor/funcy) ⭐ 3,510 | 🐛 16 | 🌐 Python | 📅 2026-08-17 ★3505 - "A fancy and practical functional tools".
...
* [Pydash](https://github.com/dgilland/pydash) ⭐ 1,448 | 🐛 5 | 🌐 Python | 📅 2026-08-29 ★1443 - "The kitchen sink of Python utility libraries for doing "stuff" in a functional way. Based on the Lo-Dash Javascript library".
...
* [Expression](https://github.com/cognitedata/Expression) ⭐ 775 | 🐛 7 | 🌐 Python | 📅 2026-09-07 ★755 - "Pragmatic functional programming for Python inspired by F#". Successor of OSlash.
...
* [fnc](https://github.com/dgilland/fnc) ⭐ 278 | 🐛 0 | 🌐 Python | 📅 2023-10-03 ★277 - "Functional programming in Python with generators and other utilities".
* [PyMonad](https://github.com/jasondelaat/pymonad) ⭐ 213 | 🐛 14 | 🌐 Python | 📅 2024-05-04 ★211 - "a small library implementing monads and related data abstractions -- functors, applicative functors, and monoids -- for use in implementing functional style programs".
...
* [katharos](https://github.com/kamalfarahani/katharos) ⭐ 75 | 🐛 0 | 🌐 Python | 📅 2026-09-06 ★32 - Typed Haskell-style functional programming library providing algebraic abstractions (Functor, Applicative, Monad, Semigroup, Monoid) with concrete types, do-notation via a `@do` decorator, and operator overloading for monadic bind, applicative apply, semigroup combine.
* [pyochain](https://github.com/OutSquareCapital/pyochain) ⭐ 71 | 🐛 14 | 🌐 Python | 📅 2026-09-07 ★59 - "Iterator, Result and Option written in Rust, for Python"
...
* [Iterpy](https://github.com/MartinBernstorff/Iterpy) ⭐ 12 | 🐛 5 | 🌐 Python | 📅 2026-08-08 ★12 - map, filter etc. as methods on a sequence.
* [enumerio](https://github.com/samedit66/enumerio) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-03-27 ★2 - Enum and Map from Elixir programming language brought into Python.

#### Return types

* [returns](https://github.com/dry-python/returns) ⭐ 4,358 | 🐛 81 | 🌐 Python | 📅 2026-09-07 ★4309 - "Make your functions return something meaningful, typed, and safe!"
...
* [maybe](https://github.com/rustedpy/maybe) ⭐ 73 | 🐛 10 | 🌐 Python | 📅 2024-12-01 ★72 - (Unmaintained) A simple Rust like Maybe type for Python 3. Fully type annotated.
* [Safetywrap](https://github.com/mplanchard/safetywrap) ⭐ 46 | 🐛 0 | 🌐 Python | 📅 2020-09-23 ★46 - Fully typesafe, Rust-like Result and Option types for Python.

#### Immutable / persistent data structures

* [Pyrsistent](https://github.com/tobgu/pyrsistent) ⭐ 2,200 | 🐛 39 | 🌐 Python | 📅 2026-01-31 ★2186 - "Persistent/Immutable/Functional data structures for Python".
* [Immutables](https://github.com/MagicStack/immutables) ⭐ 1,203 | 🐛 12 | 🌐 C | 📅 2025-05-20 ★1205 - "An immutable mapping type for Python."

Dead projects:

* [pyramda](https://github.com/jackfirth/pyramda) ⚠️ Archived ★127 - "Python package supporting heavy functional programming through currying. Translation of the Ramda library from javascript to python".
* [Discodb](https://github.com/discoproject/discodb) ⭐ 99 | 🐛 8 | 🌐 C | 📅 2019-02-21 ★99 - "An efficient, immutable, persistent mapping object".
* [Funktown](https://github.com/zhemao/funktown) ⭐ 76 | 🐛 3 | 🌐 Python | 📅 2015-10-10 ★76 - "Immutable Data Structures for Python".
* [Amino](https://github.com/tek/amino) ⚠️ Archived ★36 - "functional data structures and type classes".
...
* [pampy](https://github.com/santinic/pampy) ⭐ 3,521 | 🐛 23 | 🌐 Python | 📅 2025-01-16 ★3526 - "Pampy: The Pattern Matching for Python you always dreamed of."
...
* [Tranducers-Python](https://github.com/cognitect-labs/transducers-python) ⚠️ Archived ★204 - "Transducers are composable algorithmic transformations".
* [Transducers](https://github.com/sixty-north/python-transducers) ⭐ 58 | 🐛 1 | 🌐 Python | 📅 2017-06-29 ★58 - "This is a port of the transducer concept from Clojure to Python, with an emphasis on providing as Pythonic as interpretation of transducers as possible, rather than reproducing Clojurisms more literally".

#### Support for reactive style

* [RxPy](https://github.com/ReactiveX/RxPY) ⭐ 5,017 | 🐛 41 | 🌐 Python | 📅 2026-09-07 ★5015 - "Reactive Extensions for Python".
...
* [Glom](https://github.com/mahmoud/glom) ⭐ 2,163 | 🐛 132 | 🌐 Python | 📅 2026-07-17 ★2151 - "Python's nested data operator (and CLI), for all your declarative restructuring needs.".
...
* [deal](https://github.com/orsinium/deal) ⭐ 909 | 🐛 8 | 🌐 Python | 📅 2025-11-30 ★899 - "Design by contract for Python with many validators support."
...
* [python-mini-lambda](https://github.com/smarie/python-mini-lambda) ⭐ 14 | 🐛 2 | 🌐 Python | 📅 2020-04-24 ★14 - "Simple Lambda functions without lambda x: and with string conversion capability"
* [slist](https://github.com/thejaminator/slist) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2025-11-24 ★13 - "A drop-in replacement for the python mutable list. But with much more methods for typesafe method chaining."
* [Orinoco](https://github.com/paysure/orinoco) ⭐ 11 | 🐛 3 | 🌐 Python | 📅 2025-09-06 ★11 - "Functional composable pipelines allowing clean separation of the business logic and its implementation"
* [py-frm](https://github.com/phelps-sg/py-frm) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2023-12-02 ★2 - "Proof-of-concept Functional-Relational Mapping (FRM) for Python"
...
* [Coconut](https://github.com/evhub/coconut) ⭐ 4,354 | 🐛 90 | 🌐 Python | 📅 2026-02-16 ★4337 - "Simple, elegant, Pythonic functional programming".
* [Basilisp](https://github.com/basilisp-lang/basilisp) ⭐ 477 | 🐛 47 | 🌐 Python | 📅 2026-08-02 ★469 - "A Clojure-compatible(-ish) Lisp dialect targeting Python 3.8+".

#### Dead languages

* [pixie](https://github.com/pixie-lang/pixie) ⭐ 2,358 | 🐛 55 | 🌐 Python | 📅 2020-10-28 ★2359 - "A lightweight and native lisp built in RPython". ([Discussion on HN](https://news.ycombinator.com/item?id=13420092))
* [Mochi](https://github.com/i2y/mochi) ⭐ 912 | 🐛 14 | 🌐 Python | 📅 2016-07-07 ★913 - "A dynamically typed programming language for functional programming and actor-style programming.".
* [dg (aka dogelang)](https://github.com/pyos/dg) ⭐ 576 | 🐛 17 | 🌐 Python | 📅 2020-06-20 ★580 - "A programming language that compiles to CPython bytecode, much like Scala compiles to JVM's. That essentially means that dg is an alternative syntax for Python 3."
* [Pycket](https://github.com/pycket/pycket) ⭐ 280 | 🐛 51 | 🌐 Python | 📅 2025-08-26 ★275 - "A rudimentary Racket implementation using RPython".
* [Tydy](https://github.com/cyrus-/tydy) ⭐ 52 | 🐛 12 | 🌐 Python | 📅 2018-10-29 ★52 - "Tydy is a statically typed, functional-first programming language in the ML tradition. tydy is an implementation of Tydy as a Python library."
