...
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,090 | 🐛 16 | 🌐 Python | 📅 2026-09-14 ★4077 - "More routines for operating on iterables, beyond itertools".
* [funcy](https://github.com/suor/funcy) ⭐ 3,508 | 🐛 15 | 🌐 Python | 📅 2026-09-15 ★3505 - "A fancy and practical functional tools".
...
* [unpythonic](https://github.com/Technologicat/unpythonic) ⭐ 105 | 🐛 17 | 🌐 Python | 📅 2026-09-15 ★105 - "Supercharge your Python with parts of Lisp and Haskell."
...
* [katharos](https://github.com/kamalfarahani/katharos) ⭐ 75 | 🐛 0 | 🌐 Python | 📅 2026-09-15 ★32 - Typed Haskell-style functional programming library providing algebraic abstractions (Functor, Applicative, Monad, Semigroup, Monoid) with concrete types, do-notation via a `@do` decorator, and operator overloading for monadic bind, applicative apply, semigroup combine.
* [pyochain](https://github.com/OutSquareCapital/pyochain) ⭐ 73 | 🐛 15 | 🌐 Python | 📅 2026-09-15 ★59 - "Iterator, Result and Option written in Rust, for Python"
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,364 | 🐛 81 | 🌐 Python | 📅 2026-09-15 ★4309 - "Make your functions return something meaningful, typed, and safe!"
...
* [RxPy](https://github.com/ReactiveX/RxPY) ⭐ 5,016 | 🐛 41 | 🌐 Python | 📅 2026-09-14 ★5015 - "Reactive Extensions for Python".
...
* [Hy](https://github.com/hylang/hy) ⭐ 5,439 | 🐛 9 | 🌐 Python | 📅 2026-07-31 ★5424 - "A dialect of Lisp that's embedded in Python".
* [Coconut](https://github.com/evhub/coconut) ⭐ 4,357 | 🐛 90 | 🌐 Python | 📅 2026-02-16 ★4337 - "Simple, elegant, Pythonic functional programming".
