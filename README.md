...
* [Pydash](https://github.com/dgilland/pydash) ⭐ 1,450 | 🐛 6 | 🌐 Python | 📅 2026-07-26 ★1443 - "The kitchen sink of Python utility libraries for doing "stuff" in a functional way. Based on the Lo-Dash Javascript library".
...
* [Expression](https://github.com/cognitedata/Expression) ⭐ 766 | 🐛 30 | 🌐 Python | 📅 2025-03-11 ★755 - "Pragmatic functional programming for Python inspired by F#". Successor of OSlash.
...
* [unpythonic](https://github.com/Technologicat/unpythonic) ⭐ 105 | 🐛 16 | 🌐 Python | 📅 2026-08-14 ★105 - "Supercharge your Python with parts of Lisp and Haskell."
...
* [pyochain](https://github.com/OutSquareCapital/pyochain) ⭐ 65 | 🐛 14 | 🌐 Python | 📅 2026-08-14 ★59 - "Iterator, Result and Option written in Rust, for Python"
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,346 | 🐛 84 | 🌐 Python | 📅 2026-08-14 ★4309 - "Make your functions return something meaningful, typed, and safe!"
...
* [pampy](https://github.com/santinic/pampy) ⭐ 3,526 | 🐛 23 | 🌐 Python | 📅 2025-01-16 ★3526 - "Pampy: The Pattern Matching for Python you always dreamed of."
...
* [RxPy](https://github.com/ReactiveX/RxPY) ⭐ 5,019 | 🐛 42 | 🌐 Python | 📅 2026-08-03 ★5015 - "Reactive Extensions for Python".
...
* [Glom](https://github.com/mahmoud/glom) ⭐ 2,163 | 🐛 128 | 🌐 Python | 📅 2026-07-17 ★2151 - "Python's nested data operator (and CLI), for all your declarative restructuring needs.".
...
* [dg (aka dogelang)](https://github.com/pyos/dg) ⭐ 579 | 🐛 17 | 🌐 Python | 📅 2020-06-20 ★580 - "A programming language that compiles to CPython bytecode, much like Scala compiles to JVM's. That essentially means that dg is an alternative syntax for Python 3."
