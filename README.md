...
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,089 | 🐛 10 | 🌐 Python | 📅 2026-09-02 ★4077 - "More routines for operating on iterables, beyond itertools".
...
* [Expression](https://github.com/cognitedata/Expression) ⭐ 771 | 🐛 8 | 🌐 Python | 📅 2026-08-31 ★755 - "Pragmatic functional programming for Python inspired by F#". Successor of OSlash.
...
* [katharos](https://github.com/kamalfarahani/katharos) ⭐ 75 | 🐛 0 | 🌐 Python | 📅 2026-08-29 ★32 - Typed Haskell-style functional programming library providing algebraic abstractions (Functor, Applicative, Monad, Semigroup, Monoid) with concrete types, do-notation via a `@do` decorator, and operator overloading for monadic bind, applicative apply, semigroup combine.
* [pyochain](https://github.com/OutSquareCapital/pyochain) ⭐ 68 | 🐛 15 | 🌐 Python | 📅 2026-09-02 ★59 - "Iterator, Result and Option written in Rust, for Python"
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,356 | 🐛 81 | 🌐 Python | 📅 2026-09-01 ★4309 - "Make your functions return something meaningful, typed, and safe!"
...
* [Pyrsistent](https://github.com/tobgu/pyrsistent) ⭐ 2,200 | 🐛 38 | 🌐 Python | 📅 2026-01-31 ★2186 - "Persistent/Immutable/Functional data structures for Python".
...
* [Glom](https://github.com/mahmoud/glom) ⭐ 2,163 | 🐛 130 | 🌐 Python | 📅 2026-07-17 ★2151 - "Python's nested data operator (and CLI), for all your declarative restructuring needs.".
...
* [deal](https://github.com/orsinium/deal) ⭐ 908 | 🐛 8 | 🌐 Python | 📅 2025-11-30 ★899 - "Design by contract for Python with many validators support."
