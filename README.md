...
* [toolz](https://github.com/pytoolz/toolz) ⭐ 5,157 | 🐛 136 | 🌐 Python | 📅 2026-09-18 ★5150 - "A functional standard library for Python".
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,095 | 🐛 11 | 🌐 Python | 📅 2026-09-21 ★4077 - "More routines for operating on iterables, beyond itertools".
* [funcy](https://github.com/suor/funcy) ⭐ 3,511 | 🐛 10 | 🌐 Python | 📅 2026-09-19 ★3505 - "A fancy and practical functional tools".
...
* [Pipe](https://github.com/JulienPalard/Pipe) ⭐ 2,108 | 🐛 17 | 🌐 Python | 📅 2025-03-23 ★2103 - "A Python library to use infix notation in Python".
* [Pydash](https://github.com/dgilland/pydash) ⭐ 1,448 | 🐛 7 | 🌐 Python | 📅 2026-09-20 ★1443 - "The kitchen sink of Python utility libraries for doing "stuff" in a functional way. Based on the Lo-Dash Javascript library".
...
* [Expression](https://github.com/cognitedata/Expression) ⭐ 777 | 🐛 7 | 🌐 Python | 📅 2026-09-21 ★755 - "Pragmatic functional programming for Python inspired by F#". Successor of OSlash.
...
* [katharos](https://github.com/kamalfarahani/katharos) ⭐ 79 | 🐛 0 | 🌐 Python | 📅 2026-09-15 ★32 - Typed Haskell-style functional programming library providing algebraic abstractions (Functor, Applicative, Monad, Semigroup, Monoid) with concrete types, do-notation via a `@do` decorator, and operator overloading for monadic bind, applicative apply, semigroup combine.
* [pyochain](https://github.com/OutSquareCapital/pyochain) ⭐ 74 | 🐛 15 | 🌐 Python | 📅 2026-09-22 ★59 - "Iterator, Result and Option written in Rust, for Python"
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,366 | 🐛 81 | 🌐 Python | 📅 2026-09-21 ★4309 - "Make your functions return something meaningful, typed, and safe!"
...
* [RxPy](https://github.com/ReactiveX/RxPY) ⭐ 5,015 | 🐛 41 | 🌐 Python | 📅 2026-09-21 ★5015 - "Reactive Extensions for Python".
...
* [Glom](https://github.com/mahmoud/glom) ⭐ 2,163 | 🐛 135 | 🌐 Python | 📅 2026-09-08 ★2151 - "Python's nested data operator (and CLI), for all your declarative restructuring needs.".
...
* [deal](https://github.com/orsinium/deal) ⭐ 915 | 🐛 8 | 🌐 Python | 📅 2025-11-30 ★899 - "Design by contract for Python with many validators support."
...
* [Hy](https://github.com/hylang/hy) ⭐ 5,438 | 🐛 9 | 🌐 Python | 📅 2026-07-31 ★5424 - "A dialect of Lisp that's embedded in Python".
* [Coconut](https://github.com/evhub/coconut) ⭐ 4,356 | 🐛 91 | 🌐 Python | 📅 2026-02-16 ★4337 - "Simple, elegant, Pythonic functional programming".
