...
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,095 | 🐛 9 | 🌐 Python | 📅 2026-09-21 ★4077 - "More routines for operating on iterables, beyond itertools".
* [funcy](https://github.com/suor/funcy) ⭐ 3,510 | 🐛 9 | 🌐 Python | 📅 2026-09-19 ★3505 - "A fancy and practical functional tools".
...
* [Pydash](https://github.com/dgilland/pydash) ⭐ 1,448 | 🐛 4 | 🌐 Python | 📅 2026-09-20 ★1443 - "The kitchen sink of Python utility libraries for doing "stuff" in a functional way. Based on the Lo-Dash Javascript library".
...
* [Expression](https://github.com/cognitedata/Expression) ⭐ 776 | 🐛 7 | 🌐 Python | 📅 2026-09-21 ★755 - "Pragmatic functional programming for Python inspired by F#". Successor of OSlash.
...
* [pyochain](https://github.com/OutSquareCapital/pyochain) ⭐ 73 | 🐛 15 | 🌐 Python | 📅 2026-09-21 ★59 - "Iterator, Result and Option written in Rust, for Python"
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,365 | 🐛 81 | 🌐 Python | 📅 2026-09-21 ★4309 - "Make your functions return something meaningful, typed, and safe!"
...
* [Immutables](https://github.com/MagicStack/immutables) ⭐ 1,202 | 🐛 12 | 🌐 C | 📅 2025-05-20 ★1205 - "An immutable mapping type for Python."
