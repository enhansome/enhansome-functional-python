...
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,090 | 🐛 19 | 🌐 Python | 📅 2026-09-10 ★4077 - "More routines for operating on iterables, beyond itertools".
* [funcy](https://github.com/suor/funcy) ⭐ 3,508 | 🐛 12 | 🌐 Python | 📅 2026-09-10 ★3505 - "A fancy and practical functional tools".
...
* [PyFunctional](https://github.com/EntilZha/PyFunctional) ⭐ 2,487 | 🐛 12 | 🌐 Python | 📅 2025-03-13 ★2487 - "Python library for functional programming with collections in a data pipeline style".
* [Pipe](https://github.com/JulienPalard/Pipe) ⭐ 2,107 | 🐛 16 | 🌐 Python | 📅 2025-03-23 ★2103 - "A Python library to use infix notation in Python".
* [Pydash](https://github.com/dgilland/pydash) ⭐ 1,448 | 🐛 7 | 🌐 Python | 📅 2026-08-29 ★1443 - "The kitchen sink of Python utility libraries for doing "stuff" in a functional way. Based on the Lo-Dash Javascript library".
...
* [pyochain](https://github.com/OutSquareCapital/pyochain) ⭐ 73 | 🐛 14 | 🌐 Python | 📅 2026-09-10 ★59 - "Iterator, Result and Option written in Rust, for Python"
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,359 | 🐛 81 | 🌐 Python | 📅 2026-09-10 ★4309 - "Make your functions return something meaningful, typed, and safe!"
...
* [broqer](https://github.com/semiversus/python-broqer) ⭐ 76 | 🐛 11 | 🌐 Python | 📅 2026-09-10 ★76 - "Library to operate with continuous streams of data in a reactive style"
...
* [Glom](https://github.com/mahmoud/glom) ⭐ 2,164 | 🐛 133 | 🌐 Python | 📅 2026-09-08 ★2151 - "Python's nested data operator (and CLI), for all your declarative restructuring needs.".
...
* [deal](https://github.com/orsinium/deal) ⭐ 910 | 🐛 8 | 🌐 Python | 📅 2025-11-30 ★899 - "Design by contract for Python with many validators support."
...
* [Hy](https://github.com/hylang/hy) ⭐ 5,437 | 🐛 9 | 🌐 Python | 📅 2026-07-31 ★5424 - "A dialect of Lisp that's embedded in Python".
...
* [pixie](https://github.com/pixie-lang/pixie) ⭐ 2,357 | 🐛 55 | 🌐 Python | 📅 2020-10-28 ★2359 - "A lightweight and native lisp built in RPython". ([Discussion on HN](https://news.ycombinator.com/item?id=13420092))
